    ...
    function a(t, e) {
        ...
        var c, h, f = l.commonAncestorContainer;
    ...
    function f() {
        var t = document.body, e = document.documentElement, n = r(10) && getComputedStyle(e);
    ...
    function d(t) {
        ...
        var s = {left: n.left, top: n.top, width: n.right - n.left, height: n.bottom - n.top},
            a = "HTML" === t.nodeName ? f() : {}, h = a.width || t.clientWidth || s.right - s.left,
            d = a.height || t.clientHeight || s.bottom - s.top, p = t.offsetWidth - h, g = t.offsetHeight - d;
        if (p || g) {
            var m = e(t);
    ...
    function p(t, n) {
        var o = 2 < arguments.length && void 0 !== arguments[2] && arguments[2], s = r(10), a = "HTML" === n.nodeName,
            c = d(t), h = d(n), f = i(t), p = e(n), g = parseFloat(p.borderTopWidth, 10),
            m = parseFloat(p.borderLeftWidth, 10);
        o && "HTML" === n.nodeName && (h.top = H(h.top, 0), h.left = H(h.left, 0));
        var _ = u({top: c.top - h.top - g, left: c.left - h.left - m, width: c.width, height: c.height});
        if (_.marginTop = 0, _.marginLeft = 0, !s && a) {
            var v = parseFloat(p.marginTop, 10), E = parseFloat(p.marginLeft, 10);
        ...
        return (s && !o ? n.contains(f) : n === f && "BODY" !== f.nodeName) && (_ = function (t, e) {
            var n = 2 < arguments.length && void 0 !== arguments[2] && arguments[2], i = l(e, "top"), r = l(e, "left"),
                o = n ? -1 : 1;
    ...
    function m(t, r, o, s) {
        var c = 4 < arguments.length && void 0 !== arguments[4] && arguments[4], h = {top: 0, left: 0},
            d = c ? g(t) : a(t, r);
        if ("viewport" === s) h = function (t) {
            var e = 1 < arguments.length && void 0 !== arguments[1] && arguments[1],
                n = t.ownerDocument.documentElement, i = p(t, n), r = H(n.clientWidth, window.innerWidth || 0),
                o = H(n.clientHeight, window.innerHeight || 0), s = e ? 0 : l(n), a = e ? 0 : l(n, "left");
            return u({top: s - i.top + i.marginTop, left: a - i.left + i.marginLeft, width: r, height: o})
        }(d, c); else {
            var m;
    ...
    function b(t, e, n) {
        n = n.split("-")[0];
        var i = E(t), r = {width: i.width, height: i.height}, o = -1 !== ["right", "left"].indexOf(n),
    ...
    function A(t, e, n, r) {
        ...
        return function t(e, n, r, o) {
            ...
            a.addEventListener(n, r, {passive: !0}), s || t(i(a.parentNode), n, r, o), o.push(a)
    ...
    var B = F && window.Promise ? function (t) {
        ...
        }, K = F && !(!window.MSInputMethodContext || !document.documentMode), V = F && /MSIE 10/.test(navigator.userAgent),
        Q = function (t, e) {
        ...
        X = z.slice(3), J = "flip", Z = "clockwise", $ = "counterclockwise", tt = function () {
            function e(n, i) {
    ...
    return tt.Utils = ("undefined" == typeof window ? global : window).PopperUtils, tt.placements = z, tt.Defaults = {
        placement: "bottom", positionFixed: !1, eventsEnabled: !0, removeOnDestroy: !1, onCreate: function () {
            ...
            shift: {
                order: 100, enabled: !0, fn: function (t) {
                    ...
                    if (i) {
                        var r = t.offsets, o = r.reference, s = r.popper, a = -1 !== ["bottom", "top"].indexOf(n),
                            ...
                            h = {start: G({}, l, o[l]), end: G({}, l, o[l] + o[c] - s[c])};
                ...
                order: 400, enabled: !0, fn: function (t) {
                    var e = t.offsets, n = e.popper, i = e.reference, r = t.placement.split("-")[0], o = R,
                ...
                order: 500, enabled: !0, fn: function (t, n) {
                    ...
                    var o = t.placement.split("-")[0], s = t.offsets, a = s.popper, l = s.reference,
                        c = -1 !== ["left", "right"].indexOf(o), h = c ? "height" : "width", f = c ? "Top" : "Left",
                        d = f.toLowerCase(), p = c ? "left" : "top", g = c ? "bottom" : "right", m = E(r)[h];
                    l[g] - m < a[d] && (t.offsets.popper[d] -= a[d] - (l[g] - m)), l[d] + m > a[g] && (t.offsets.popper[d] += l[d] + m - a[g]), t.offsets.popper = u(t.offsets.popper);
                    var _ = l[d] + l[h] / 2 - m / 2, v = e(t.instance.popper), y = parseFloat(v["margin" + f], 10),
                        b = parseFloat(v["border" + f + "Width"], 10), T = _ - t.offsets.popper[d] - y - b;
                ...
                order: 600, enabled: !0, fn: function (t, e) {
                    ...
                    return s.forEach(function (a, l) {
                        ...
                        var c, h = t.offsets.popper, f = t.offsets.reference, u = R,
                ...
                order: 850, enabled: !0, fn: function (t, e) {
                    var n = e.x, i = e.y, r = t.offsets.popper, s = T(t.instance.modifiers, function (t) {
                        return "applyStyle" === t.name
                    }).gpuAcceleration;
                    void 0 !== s && console.warn("WARNING: `gpuAcceleration` option moved to `computeStyle` modifier and will not be supported in future versions of Popper.js!");
                    var a, l, c = void 0 === s ? e.gpuAcceleration : s, h = d(o(t.instance.popper)),
                        f = {position: r.position},
                        u = {left: R(r.left), top: j(r.top), bottom: j(r.bottom), right: R(r.right)},
                        p = "bottom" === n ? "top" : "bottom", g = "right" === i ? "left" : "right", m = I("transform");
                    if (l = "bottom" == p ? -h.height + u.bottom : u.top, a = "right" == g ? -h.width + u.right : u.left, c && m) f[m] = "translate3d(" + a + "px, " + l + "px, 0)", f[p] = 0, f[g] = 0, f.willChange = "transform"; else {
                        var _ = "bottom" == p ? -1 : 1, v = "right" == g ? -1 : 1;
    ...
    var s, a, l, c, h, f, u, d, p, g, m, _, v, E, y, b, T, C, w, I, D, A, S, O, N, k, L, P, x, j, R, H, F, W, M, U, B,
        K, V, Q, Y, G, q, z, X, J, Z, $, tt, et, nt, it, rt, ot, st, at, lt, ct, ht, ft, ut, dt, pt, gt, mt, _t, vt, Et,
        yt, bt, Tt, Ct, wt, It, Dt, At, St, Ot, Nt, kt, Lt, Pt, xt, jt, Rt, Ht, Ft, Wt, Mt, Ut, Bt, Kt, Vt, Qt, Yt, Gt,
        qt, zt, Xt, Jt, Zt, $t, te, ee, ne, ie, re, oe, se, ae, le, ce, he, fe, ue, de, pe, ge, me, _e, ve, Ee, ye, be,
        Te, Ce, we, Ie, De, Ae, Se, Oe, Ne, ke, Le, Pe, xe, je, Re, He, Fe, We, Me, Ue, Be, Ke, Ve, Qe, Ye, Ge, qe, ze,
        Xe, Je, Ze, $e, tn, en, nn, rn = function (t) {
            var e = "transitionend";
            var n = {
            ...
            return t.fn.emulateTransitionEnd = function (e) {
                ...
                bindType: e, delegateType: e, handle: function (e) {
                    if (t(e.target).is(this)) return e.handleObj.handler.apply(this, arguments)
                }
            }, n
        }(e), on = (a = "alert", c = "." + (l = "bs.alert"), h = (s = e).fn[a], f = {
            CLOSE: "close" + c,
            CLOSED: "closed" + c,
            ...
            return e.close = function (t) {
                ...
                var e = rn.getSelectorFromElement(t), n = !1;
        ...
        sn = (p = "button", m = "." + (g = "bs.button"), _ = ".data-api", v = (d = e).fn[p], E = "active", "btn", y = '[data-toggle^="button"]', b = '[data-toggle="buttons"]', "input", T = ".active", C = ".btn", w = {
            ...
            return e.toggle = function () {
                var t = !0, e = !0, n = d(this._element).closest(b)[0];
                if (n) {
        ...
        }, I), an = (A = "carousel", O = "." + (S = "bs.carousel"), N = ".data-api", k = (D = e).fn[A], L = {
            interval: 5e3,
            keyboard: !0,
            slide: !1,
            pause: "hover",
            ...
            return e.next = function () {
                ...
                var n = t === x, i = t === j, r = this._getItemIndex(e), o = this._items.length - 1;
                if ((i && 0 === r || n && r === o) && !this._config.wrap) return e;
                var s = (r + (t === j ? -1 : 1)) % this._items.length;
                return -1 === s ? this._items[this._items.length - 1] : this._items[s]
            }, e._triggerSlideEvent = function (t, e) {
                var n = this._getItemIndex(t), i = this._getItemIndex(D(this._element).find(K.ACTIVE_ITEM)[0]),
                    r = D.Event(R.SLIDE, {relatedTarget: t, direction: e, from: i, to: n});
                ...
                var n, i, r, o = this, s = D(this._element).find(K.ACTIVE_ITEM)[0], a = this._getItemIndex(s),
                ...
                if (t === x ? (n = M, i = U, r = "left") : (n = W, i = B, r = "right"), l && D(l).hasClass(F)) this._isSliding = !1; else if (!this._triggerSlideEvent(l, r).isDefaultPrevented() && s && l) {
                    ...
                    var f = D.Event(R.SLID, {relatedTarget: l, direction: r, from: a, to: c});
                ...
                return this.each(function () {
                    var n = D(this).data(S), i = o({}, L, D(this).data());
                ...
                if (n) {
                    var i = D(n)[0];
                    if (i && D(i).hasClass(H)) {
                        var r = o({}, D(i).data(), D(this).data()), s = this.getAttribute("data-slide-to");
        ...
        }, V), ln = (Y = "collapse", q = "." + (G = "bs.collapse"), z = (Q = e).fn[Y], X = {
            toggle: !0,
            parent: ""
        }, J = {toggle: "boolean", parent: "(string|element)"}, Z = {
            SHOW: "show" + q,
            SHOWN: "shown" + q,
            HIDE: "hide" + q,
            HIDDEN: "hidden" + q,
            ...
            function t(t, e) {
                ...
                for (var n = Q(rt.DATA_TOGGLE), i = 0; i < n.length; i++) {
                    var r = n[i], o = rn.getSelectorFromElement(r);
            ...
            return e.toggle = function () {
                ...
                if (!this._isTransitioning && Q(this._element).hasClass($)) {
                    ...
                    if (Q(this._element).trigger(e), !e.isDefaultPrevented()) {
                        ...
                        if (this._element.style[n] = this._element.getBoundingClientRect()[n] + "px", rn.reflow(this._element), Q(this._element).addClass(et).removeClass(tt).removeClass($), 0 < this._triggerArray.length) for (var i = 0; i < this._triggerArray.length; i++) {
                            var r = this._triggerArray[i], o = rn.getSelectorFromElement(r);
                ...
                return this.each(function () {
                    var n = Q(this), i = n.data(G), r = o({}, X, n.data(), "object" == typeof e && e ? e : {});
            ...
            var e = Q(this), n = rn.getSelectorFromElement(this);
            Q(n).each(function () {
                var t = Q(this), n = t.data(G) ? "toggle" : e.data();
        ...
        cn = (at = "dropdown", ct = "." + (lt = "bs.dropdown"), ht = ".data-api", ft = (st = e).fn[at], ut = new RegExp("38|40|27"), dt = {
            ...
            return e.toggle = function () {
                if (!this._element.disabled && !st(this._element).hasClass(pt)) {
                    var e = t._getParentFromElement(this._element), i = st(this._menu).hasClass(gt);
                    if (t._clearMenus(), !i) {
                        var r = {relatedTarget: this._element}, o = st.Event(dt.SHOW, r);
                ...
                var t = st(this._element).parent(), e = At;
                ...
                if (!e || 3 !== e.which && ("keyup" !== e.type || 9 === e.which)) for (var n = st.makeArray(st(yt)), i = 0; i < n.length; i++) {
                    var r = t._getParentFromElement(n[i]), o = st(n[i]).data(lt), s = {relatedTarget: n[i]};
                    if (o) {
                        var a = o._menu;
                ...
                var e, n = rn.getSelectorFromElement(t);
                ...
                if ((/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || st(e.target).closest(Tt).length)) : ut.test(e.which)) && (e.preventDefault(), e.stopPropagation(), !this.disabled && !st(this).hasClass(pt))) {
                    var n = t._getParentFromElement(this), i = st(n).hasClass(gt);
        ...
        }, Pt), hn = (jt = "modal", Ht = "." + (Rt = "bs.modal"), Ft = (xt = e).fn[jt], Wt = {
            backdrop: !0,
            keyboard: !0,
            focus: !0,
            show: !0
            ...
            return e.toggle = function (t) {
                ...
                var e = this, n = xt(this._element).hasClass(Qt);
                ...
                var i = xt.Event(Ut.SHOWN, {relatedTarget: t}), r = function () {
                ...
                var e = this, n = xt(this._element).hasClass(Qt) ? Qt : "";
                ...
                return this.each(function () {
                    var i = xt(this).data(Rt), r = o({}, Wt, xt(this).data(), "object" == typeof e && e ? e : {});
            ...
            var e, n = this, i = rn.getSelectorFromElement(this);
            i && (e = xt(i)[0]);
        ...
        fn = (Xt = "tooltip", Zt = "." + (Jt = "bs.tooltip"), $t = (zt = e).fn[Xt], te = "bs-tooltip", ee = new RegExp("(^|\\s)" + te + "\\S+", "g"), re = {
            ...
            return e.enable = function () {
                ...
                if (this._isEnabled) if (t) {
                    var e = this.constructor.DATA_KEY, n = zt(t.currentTarget).data(e);
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    var r = this.getTipElement(), o = rn.getUID(this.constructor.NAME);
                ...
                var e = this, n = this.getTipElement(), i = zt.Event(this.constructor.Event.HIDE), r = function () {
                ...
                var t = zt(this.getTipElement()), e = t.attr("class").match(ee);
                ...
                return this.each(function () {
                    var n = zt(this).data(Jt), i = "object" == typeof e && e;
        ...
        un = (ge = "popover", _e = "." + (me = "bs.popover"), ve = (pe = e).fn[ge], Ee = "bs-popover", ye = new RegExp("(^|\\s)" + Ee + "\\S+", "g"), be = o({}, fn.Default, {
        ...
        }), Te = o({}, fn.DefaultType, {content: "(string|element|function)"}), "fade", Ce = ".popover-header", we = ".popover-body", Ie = {
            HIDE: "hide" + _e,
            HIDDEN: "hidden" + _e,
            SHOW: "show" + _e,
            SHOWN: "shown" + _e,
            ...
            return o.isWithContent = function () {
                ...
                var t = pe(this.getTipElement()), e = t.attr("class").match(ye);
                null !== e && 0 < e.length && t.removeClass(e.join(""))
            }, i._jQueryInterface = function (t) {
                return this.each(function () {
                    var e = pe(this).data(me), n = "object" == typeof t ? t : null;
        ...
        }, De), dn = (Se = "scrollspy", Ne = "." + (Oe = "bs.scrollspy"), ke = (Ae = e).fn[Se], Le = {
            offset: 10,
            method: "auto",
            target: ""
        }, Pe = {offset: "number", method: "string", target: "(string|element)"}, xe = {
            ...
            return e.refresh = function () {
                ...
                var n = Ae(e.join(","));
                n.hasClass(je) ? (n.closest(He.DROPDOWN).find(He.DROPDOWN_TOGGLE).addClass(Re), n.addClass(Re)) : (n.addClass(Re), n.parents(He.NAV_LIST_GROUP).prev(He.NAV_LINKS + ", " + He.LIST_ITEMS).addClass(Re), n.parents(He.NAV_LIST_GROUP).prev(He.NAV_ITEMS).children(He.NAV_LINKS).addClass(Re)), Ae(this._scrollElement).trigger(xe.ACTIVATE, {relatedTarget: t})
            }, e._clear = function () {
        ...
        }, We), pn = (Be = "." + (Ue = "bs.tab"), Ke = (Me = e).fn.tab, Ve = {
            HIDE: "hide" + Be,
            HIDDEN: "hidden" + Be,
            SHOW: "show" + Be,
            SHOWN: "shown" + Be,
            ...
            return e.show = function () {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && Me(this._element).hasClass(Ye) || Me(this._element).hasClass(Ge))) {
                    var e, n, i = Me(this._element).closest(Xe)[0], r = rn.getSelectorFromElement(this._element);
                    if (i) {
                        var o = "UL" === i.nodeName ? Ze : Je;
                        n = (n = Me.makeArray(Me(i).find(o)))[n.length - 1]
                    }
                    var s = Me.Event(Ve.HIDE, {relatedTarget: this._element}), a = Me.Event(Ve.SHOW, {relatedTarget: n});
                ...
                var i = this, r = ("UL" === e.nodeName ? Me(e).find(Ze) : Me(e).children(Je))[0],
                    o = n && r && Me(r).hasClass("fade"), s = function () {
    ...
    }(e), t.Util = rn, t.Alert = on, t.Button = sn, t.Carousel = an, t.Collapse = ln, t.Dropdown = cn, t.Modal = hn, t.Popover = un, t.Scrollspy = dn, t.Tab = pn, t.Tooltip = fn, Object.defineProperty(t, "__esModule", {value: !0})
});
