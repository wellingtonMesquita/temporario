                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="form" action="{{route('publicacao.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <button class="btn btn-light" href="{{route('publicacao.index') }}">Cancel</button>
                            </form>
                        </div>
                    </div>
                </div>
