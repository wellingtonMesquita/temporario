<nav class="sidebar sidebar-offcanvas style-sidebar" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('publicacao.index')); ?>">
                <span class="menu-title">Publicação</span>
                <i class="mdi mdi-format-list-bulleted menu-icon"></i>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('anuncios.index')); ?>">
...
<?php /**PATH /var/www/acompanhantes-unai/resources/views/includes/admin/sidebar.blade.php ENDPATH**/ ?>